...
#lp = LocalProblems(mesh_file = None, boundary_condition_type = 1, dataset = 'imex_datasets/data_20_mesh.dat')

############### RUN LOCAL UPSCALING ###############
#lu = LocalUpscaling(mesh_file = None, boundary_condition_type = 1, dataset = 'imex_datasets/data_20_mesh.dat')
